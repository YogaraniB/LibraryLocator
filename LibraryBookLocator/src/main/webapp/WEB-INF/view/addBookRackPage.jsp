...
<form action="registersaveBookRack" style="max-width:500px;margin:auto">
  <h2>Add Book Rack Here</h2>
  
 
  <div class="input-container">
    <i class="fa fa-server icon"></i>
    <input class="input-field" type="text" placeholder="BookRackId" name="bookRackId">
  </div>
  
   <div class="input-container">
    <i class="fa fa-comment icon"></i>
    <input class="input-field" type="text" placeholder="BookType" name="bookType">
  </div>
